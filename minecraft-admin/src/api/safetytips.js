...
const safetyTipsApi = {
  ...
  // 新增安全知识提示
  addSafetyTip: (safetyTip) => {
    return request.post('/safety-tips', safetyTip);
  },

  // 更新安全知识提示
  updateSafetyTip: (safetyTip) => {
    return request.put('/safety-tips', safetyTip);
  },

  // 删除安全知识提示
  deleteSafetyTip: (id) => {
    return request.delete(`/safety-tips/${id}`);
  }
};
