          ...
          <div class="user-actions" v-else>
            <div class="profilepicture">
              ...
              <div class="profilepicture-inner" v-show="isDropdownVisible">
                <button v-for="item in filteredUserMenuItems" :key="item.label" :style="item.style" :class="item.class"
