...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='购物车表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=88 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='聊天消息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `chat_message` (`id`, `sender_id`, `receiver_id`, `content`, `message_type`, `is_read`, `create_time`) VALUES (58,21,15,'😴','emoji',1,'2026-05-12 12:50:47'),(59,22,15,'http://localhost:8080/upload/3988b87e-6425-4419-94ff-cb516ee41beb.webp','emoji',1,'2026-05-12 14:22:17'),(60,22,15,'仔阿康吗','text',1,'2026-05-12 14:22:23'),(61,22,15,'🚀','emoji',1,'2026-05-12 14:23:48'),(62,19,15,'撒旦','text',1,'2026-05-12 17:32:34'),(63,19,15,'你好呀','text',1,'2026-05-14 22:34:30'),(64,15,19,'嗯嗯干什么','text',1,'2026-05-14 22:34:37'),(65,15,19,'🚀','emoji',1,'2026-05-14 22:34:41'),(66,15,19,'http://localhost:8080/upload/a7ad4450-614d-4766-b7bc-d3e74bbe0922.jpeg','emoji',1,'2026-05-14 22:34:45'),(67,19,15,'http://localhost:8080/upload/06091029-102d-46b6-a900-767389935712.png','image',1,'2026-05-14 22:34:55'),(68,23,15,'📚','emoji',0,'2026-06-05 21:46:57'),(69,23,15,'你在干嘛呢？','text',0,'2026-06-05 21:47:10'),(70,15,23,'吃饭饭','text',1,'2026-06-05 21:47:18'),(71,19,15,'😘','emoji',1,'2026-06-22 23:32:09'),(72,15,19,'😃','text',1,'2026-06-22 23:32:27'),(73,15,19,'😃','text',1,'2026-06-23 23:17:21'),(74,15,19,'123213','text',1,'2026-06-23 23:17:25'),(75,15,22,'🎁','emoji',0,'2026-07-02 22:37:21'),(76,15,22,'在干嘛呀','text',0,'2026-07-02 22:37:31'),(77,22,15,'吃饭呢怎么了','text',1,'2026-07-02 22:37:45'),(78,15,21,'📚','emoji',0,'2026-07-02 22:43:50'),(79,15,21,'🚀','emoji',0,'2026-07-02 22:48:05'),(80,15,19,'🚀','emoji',1,'2026-07-11 23:05:57'),(81,15,19,'在干嘛你🚀','text',1,'2026-07-11 23:06:25'),(82,19,15,'吃饭','text',1,'2026-07-11 23:06:40'),(83,15,19,'我来了','text',1,'2026-08-24 01:05:05'),(84,15,19,'啥玩意你干嘛','text',1,'2026-08-24 01:05:15'),(85,19,15,'好无聊啊','text',1,'2026-08-24 01:06:01'),(86,19,15,'来找我玩呀','text',1,'2026-08-24 01:06:13'),(87,15,21,'🚀','emoji',0,'2026-08-30 15:10:45');
...
INSERT INTO `features` (`id`, `icon`, `title`, `description`, `bg_color`, `sort_order`, `created_at`, `updated_at`) VALUES (1,'http://localhost:8080/upload/44730778-efba-4bea-b81e-68c588a7792a.png','资讯中心','提供实时、全面的旅游资讯与攻略','linear-gradient(135deg, #e0f2fe 0%, #bae6fd 100%)',1,'2026-08-04 22:37:05','2026-08-04 23:22:45'),(2,'http://localhost:8080/upload/6a324d4c-7ed1-4828-88e6-bc62c0b6c22e.png','预订服务','一站式预订酒店、机票与门票','linear-gradient(135deg, #fef3c7 0%, #fde68a 100%)',2,'2026-08-04 22:37:05','2026-08-04 23:22:58'),(3,'http://localhost:8080/upload/51d0ebb9-5d3b-44c8-a580-7ea15e472bf2.png','美食探索','发现地道美食，品味地方特色','linear-gradient(135deg, #fce7f3 0%, #fbcfe8 100%)',3,'2026-08-04 22:37:05','2026-08-04 23:23:09'),(4,'http://localhost:8080/upload/b09675b0-8946-459e-920b-dbdb724611aa.png','社区互动','与旅友交流分享，记录旅途点滴','linear-gradient(135deg, #d1fae5 0%, #a7f3d0 100%)',4,'2026-08-04 22:37:05','2026-08-04 23:23:19'),(5,'http://localhost:8080/upload/bb7e8f9c-34eb-4f69-a6f4-401c9e7717bb.png','商品商城','精选旅行好物，让出行更轻松','linear-gradient(135deg, #ede9fe 0%, #ddd6fe 100%)',5,'2026-08-04 22:37:05','2026-08-04 23:23:34'),(6,'http://localhost:8080/upload/419a67a2-68f8-424e-afb5-1daa8a600fb6.png','数据洞察','智能分析旅行趋势与用户偏好','linear-gradient(135deg, #ffe4e6 0%, #fecdd3 100%)',6,'2026-08-04 22:37:05','2026-08-04 23:23:44');
...
CREATE TABLE `group_chat_message` (
  ...
  KEY `idx_create_time` (`create_time`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='群聊消息表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=236 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='登录日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `login_log` (`id`, `user_id`, `username`, `account`, `ipaddr`, `login_location`, `browser`, `os`, `status`, `msg`, `login_time`) VALUES (69,NULL,NULL,'20260314813731','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','0','用户不存在','2026-04-16 21:36:40'),(104,21,'王涛','20260314207018','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功','2026-05-13 20:51:56'),(117,23,'王伟明','20260605552011','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-06-05 21:45:42'),(136,21,'王涛','20260314207018','0:0:0:0:0:0:0:1','内网IP','Safari','iOS','1','登录成功','2026-07-02 22:43:33'),(161,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-05 00:00:23'),(162,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','管理员登录成功','2026-08-05 00:00:23'),(163,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功','2026-08-22 22:43:52'),(165,NULL,NULL,'233510201301','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','0','用户不存在','2026-08-26 00:24:38'),(166,NULL,NULL,'vben','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','0','用户不存在','2026-08-26 00:25:24'),(167,NULL,NULL,'233510201301','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','0','用户不存在','2026-08-26 00:25:39'),(168,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功','2026-08-26 00:26:20'),(169,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','管理员登录成功','2026-08-26 00:26:20'),(170,NULL,NULL,'vben','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','0','用户不存在','2026-08-26 00:26:25'),(171,NULL,NULL,'vben','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','0','用户不存在','2026-08-26 00:26:30'),(172,NULL,NULL,'vben','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','0','用户不存在','2026-08-26 00:26:53'),(173,NULL,NULL,'vben','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','0','用户不存在','2026-08-26 00:27:13'),(174,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 00:29:05'),(175,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 00:29:22'),(176,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 00:31:00'),(177,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 00:36:55'),(178,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功','2026-08-26 01:17:42'),(179,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:17:53'),(180,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:18:06'),(181,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:18:09'),(182,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:18:09'),(183,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:18:09'),(184,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:18:09'),(185,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:18:10'),(186,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:18:10'),(187,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:18:10'),(188,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:18:10'),(189,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:18:24'),(190,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:18:31'),(191,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:18:32'),(192,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:18:32'),(193,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:18:32'),(194,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:18:32'),(195,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:18:33'),(196,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:18:33'),(197,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:18:33'),(198,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:18:33'),(199,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:18:33'),(200,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:18:34'),(201,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:18:34'),(202,NULL,NULL,'vben','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','0','用户不存在','2026-08-26 01:18:42'),(203,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:18:45'),(204,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:18:51'),(205,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:19:01'),(206,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:19:21'),(207,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:19:31'),(208,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:19:40'),(209,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 01:20:04'),(210,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功','2026-08-26 20:01:03'),(211,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 20:01:39'),(212,NULL,NULL,'vben','0:0:0:0:0:0:0:1','内网IP','cURL','其他操作系统','0','用户不存在','2026-08-26 20:07:04'),(213,NULL,NULL,'admin','0:0:0:0:0:0:0:1','内网IP','cURL','其他操作系统','0','用户不存在','2026-08-26 20:07:15'),(214,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 20:08:41'),(215,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 20:08:45'),(216,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 20:08:45'),(217,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 20:08:46'),(218,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 20:08:46'),(219,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 20:08:46'),(220,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 20:08:46'),(221,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 20:08:46'),(222,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 20:10:22'),(223,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 20:10:49'),(224,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 20:18:51'),(225,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 20:30:53'),(226,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功','2026-08-26 20:33:33'),(227,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 20:36:48'),(228,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功','2026-08-26 22:08:04'),(229,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 22:08:08'),(230,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 22:16:35'),(231,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功（缓存）','2026-08-26 22:18:10'),(232,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功','2026-08-27 20:16:05'),(233,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功','2026-08-30 12:04:44'),(234,15,'爱吃薯条的小懒猪','20260219132871','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功','2026-08-30 14:09:54'),(235,19,'李小明','20260314838329','0:0:0:0:0:0:0:1','内网IP','Chrome','Windows','1','登录成功','2026-08-30 15:14:02');
...
INSERT INTO `online_users` (`id`, `username`, `nickname`, `role`, `login_ip`, `login_time`, `last_activity_time`, `browser`, `os`, `status`) VALUES (15,'爱吃薯条的小懒猪','小可爱','admin','0:0:0:0:0:0:0:1','2026-08-30 14:09:54','2026-08-30 14:09:54','Chrome','Windows','online'),(19,'李小明','李小明','vip','0:0:0:0:0:0:0:1','2026-08-30 15:14:02','2026-08-30 15:14:02','Chrome','Windows','online'),(21,'王涛','王涛','vip','0:0:0:0:0:0:0:1','2026-07-02 22:43:33','2026-07-02 22:43:33','Safari','iOS','online');
...
INSERT INTO `operation_logs` (`id`, `user_id`, `username`, `operation_type`, `operation_desc`, `request_uri`, `request_method`, `request_params`, `response_result`, `execution_time`, `status`, `error_msg`, `module`, `browser`, `os`, `ip_address`, `user_agent`, `created_at`, `updated_at`) VALUES (1,15,'15','UPDATE','FoodController.updateFood','/api/food/update','PUT','[{\"address\":\"北京市东城区前门大街30号\",\"city\":\"北京\",\"commodity\":\"0\",\"coverImage\":\"http://localhost:8080/upload/ed071f0c-f397-4e79-984e-81b2abc8df9c.png\",\"cuisineType\":\"京菜\",\"description\":\"北京传统名菜，外酥里嫩，香气四溢。\",\"id\":3,\"images\":\"https://example.com/food1_1.jpg,https://example.com/food1_2.jpg\",\"name\":\"北京烤鸭\",\"price\":268,\"province\":\"北京\",\"rating\":4,\"status\":1,\"tags\":\"传统,烤鸭,必吃\",\"updateTime\":\"2026-08-30 14:51:01.874796400\"}]',NULL,60,1,NULL,NULL,'Chrome','Windows','0:0:0:0:0:0:0:1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36','2026-08-30 14:51:02','2026-08-30 14:51:02'),(2,NULL,'anonymousUser','ADD','SystemLogController.saveSystemLog','/api/system-logs/add','POST','[{\"action\":\"string\",\"content\":\"string\",\"createdAt\":\"2026-08-30 06:53:23.759\",\"errorStack\":\"string\",\"executionTime\":0,\"id\":2,\"logLevel\":\"string\",\"logType\":\"string\",\"module\":\"string\",\"requestId\":\"string\",\"requestMethod\":\"string\",\"requestParams\":\"string\",\"requestUrl\":\"string\",\"responseData\":\"string\",\"serverHost\":\"string\",\"serverPort\":0,\"spanId\":\"string\",\"status\":\"string\",\"traceId\":\"string\",\"userAgent\":\"string\",\"userId\":0,\"userIp\":\"string\",\"username\":\"string\"}]',NULL,29,1,NULL,NULL,'Chrome','Windows','0:0:0:0:0:0:0:1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36','2026-08-30 14:53:25','2026-08-30 14:53:25'),(3,0,'string','string','string','string','string','string','string',0,0,'string','string','string','string','string','string','2026-08-30 06:53:38','2026-08-30 06:53:38'),(4,NULL,'anonymousUser','ADD','OperationLogController.saveOperationLog','/api/operation-logs/add','POST','[{\"browser\":\"string\",\"createdAt\":\"2026-08-30 06:53:38.349\",\"errorMsg\":\"string\",\"executionTime\":0,\"id\":3,\"ipAddress\":\"string\",\"module\":\"string\",\"operationDesc\":\"string\",\"operationType\":\"string\",\"os\":\"string\",\"requestMethod\":\"string\",\"requestParams\":\"string\",\"requestUri\":\"string\",\"responseResult\":\"string\",\"status\":0,\"updatedAt\":\"2026-08-30 06:53:38.349\",\"userAgent\":\"string\",\"userId\":0,\"username\":\"string\"}]',NULL,8,1,NULL,NULL,'Chrome','Windows','0:0:0:0:0:0:0:1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36','2026-08-30 14:53:41','2026-08-30 14:53:41'),(5,0,'string','string','string','string','string','string','string',0,0,'string','string','string','string','string','string','2026-08-30 06:53:38','2026-08-30 06:53:38'),(6,NULL,'anonymousUser','ADD','OperationLogController.saveOperationLog','/api/operation-logs/add','POST','[{\"browser\":\"string\",\"createdAt\":\"2026-08-30 06:53:38.349\",\"errorMsg\":\"string\",\"executionTime\":0,\"id\":5,\"ipAddress\":\"string\",\"module\":\"string\",\"operationDesc\":\"string\",\"operationType\":\"string\",\"os\":\"string\",\"requestMethod\":\"string\",\"requestParams\":\"string\",\"requestUri\":\"string\",\"responseResult\":\"string\",\"status\":0,\"updatedAt\":\"2026-08-30 06:53:38.349\",\"userAgent\":\"string\",\"userId\":0,\"username\":\"string\"}]',NULL,7,1,NULL,NULL,'Chrome','Windows','0:0:0:0:0:0:0:1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36','2026-08-30 14:55:47','2026-08-30 14:55:47'),(7,15,'15','ADD','ImController.sendSingleMessage','/api/public/im/single/send','POST','[{\"content\":\"🚀\",\"messageType\":\"emoji\",\"receiverId\":21,\"senderId\":15}]',NULL,12,1,NULL,NULL,'Chrome','Windows','0:0:0:0:0:0:0:1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36','2026-08-30 15:10:45','2026-08-30 15:10:45'),(8,15,'15','ADD','OnlineUserController.forceLogout','/api/online-users/logout/22','POST','[22]',NULL,17,1,NULL,NULL,'Chrome','Windows','0:0:0:0:0:0:0:1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36','2026-08-30 15:12:36','2026-08-30 15:12:36'),(9,NULL,'anonymousUser','ADD','AuthController.login','/api/auth/login','POST','[{\"account\":\"20260314838329\",\"password\":\"123456\"}]',NULL,136,1,NULL,NULL,'Edge','Windows','0:0:0:0:0:0:0:1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36 Edg/152.0.0.0','2026-08-30 15:14:02','2026-08-30 15:14:02'),(10,19,'19','UPDATE','SafetyTipsController.updateSafetyTip','/api/safety-tips','PUT','[{\"description\":\"在夜间出行时要选择明亮的路线，避免前往偏僻的地方，注意自身安全...\",\"id\":40,\"imageUrl\":\"http://localhost:8080/upload/e43d21d9-02d5-453a-82fb-ce9e04389950.png\",\"sortWeight\":10,\"status\":1,\"title\":\"夜间出行安全注意事项\"}]',NULL,4,1,NULL,NULL,'Edge','Windows','0:0:0:0:0:0:0:1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36 Edg/152.0.0.0','2026-08-30 15:14:57','2026-08-30 15:14:57'),(11,15,'15','ADD','CartController.addToCart','/api/cart/add','POST','[{\"createTime\":\"2026-08-30 15:32:30.772967700\",\"id\":20,\"image\":\"http://localhost:8080/upload/ed071f0c-f397-4e79-984e-81b2abc8df9c.png\",\"itemId\":3,\"itemName\":\"北京烤鸭\",\"itemType\":\"food\",\"price\":268,\"quantity\":1,\"updateTime\":\"2026-08-30 15:32:30.772967700\",\"userId\":15}]',NULL,25,1,NULL,NULL,'Chrome','Windows','0:0:0:0:0:0:0:1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/152.0.0.0 Safari/537.36','2026-08-30 15:32:31','2026-08-30 15:32:31');
...
CREATE TABLE `system_log` (
  `id` bigint NOT NULL AUTO_INCREMENT COMMENT '主键ID',
  `trace_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '追踪ID（分布式链路追踪）',
  `span_id` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '跨度ID',
  `user_id` bigint DEFAULT NULL COMMENT '操作用户ID',
  `username` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '操作用户名',
  `user_ip` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '操作IP地址',
  ...
  `log_level` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT 'INFO' COMMENT '日志级别：DEBUG, INFO, WARN, ERROR',
  `log_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '日志类型：OPERATION, SYSTEM, SECURITY, BUSINESS',
  `module` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '模块名称',
  `action` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '操作动作',
  ...
  `status` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT 'SUCCESS' COMMENT '状态：SUCCESS, FAIL, ERROR',
  `error_stack` text COLLATE utf8mb4_unicode_ci COMMENT '错误堆栈',
  `server_host` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '服务器主机',
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='系统日志表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `system_log` (`id`, `trace_id`, `span_id`, `user_id`, `username`, `user_ip`, `user_agent`, `request_id`, `log_level`, `log_type`, `module`, `action`, `content`, `request_url`, `request_method`, `request_params`, `response_data`, `execution_time`, `status`, `error_stack`, `server_host`, `server_port`, `created_at`) VALUES (1,'58ecbe58f76845158f2d93b8bbc23ede',NULL,NULL,NULL,NULL,NULL,'048d098dd3ab446291f514d633211d91','INFO','SYSTEM','系统','应用启动','系统启动成功，服务器主机: DESKTOP-JE62AKO，端口: 8080',NULL,NULL,NULL,NULL,NULL,'SUCCESS',NULL,'DESKTOP-JE62AKO',8080,'2026-08-30 14:48:31'),(2,'string','string',0,'string','string','string','string','string','string','string','string','string','string','string','string','string',0,'string','string','string',0,'2026-08-30 06:53:24');
...
-- Dump completed on 2026-08-30 20:08:36
